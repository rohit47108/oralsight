...
FIRST_ADMIN_CONFIRMATION_PHRASE = "BOOTSTRAP ORALSIGHT FIRST ADMIN"
ADDITIONAL_ADMIN_CONFIRMATION_PHRASE = "ADD ORALSIGHT ADMIN"
RECOVERY_ADMIN_CONFIRMATION_PHRASE = (
    "RECOVER ORALSIGHT SEALED INSTALLATION WITH ZERO ADMINS"
)
ADMIN_BOOTSTRAP_SEAL_KEY = "first_admin_bootstrap_v1"
_SUBJECT_ENV = "ORALSIGHT_PLATFORM_BOOTSTRAP_ADMIN_SUBJECT"
_CONFIRMATION_ENV = "ORALSIGHT_PLATFORM_BOOTSTRAP_CONFIRMATION"
_ADMIN_TARGET_ENV = "ORALSIGHT_PLATFORM_ADMIN_TARGET_SUBJECT"
_ADMIN_REFERENCE_ENV = "ORALSIGHT_PLATFORM_ADMIN_REFERENCE_SUBJECT"
_ADMIN_CONFIRMATION_ENV = "ORALSIGHT_PLATFORM_ADMIN_CONFIRMATION"
_RECOVERY_TARGET_ENV = "ORALSIGHT_PLATFORM_RECOVERY_ADMIN_SUBJECT"
_RECOVERY_CONFIRMATION_ENV = "ORALSIGHT_PLATFORM_RECOVERY_CONFIRMATION"
_LOCK_NAMESPACE = "oralsight:first-admin-bootstrap:v1"
