...
DOCUMENT_ID = "oralsight-product-consent"
DOCUMENT_VERSION = "2026-08-06"
TITLE = "OralSight research application consent"
BODY = """OralSight is a non-diagnostic research application. It can store selected mouth images, symptom context, image observations, and reports in your protected account when you choose cloud features. Automated outputs can be wrong and do not replace an examination by a dentist or medical professional.
