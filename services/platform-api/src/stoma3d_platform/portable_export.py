...
SCHEMA_VERSION = "stoma3d.portable-export.v1"
SCHEME = "x25519-hkdf-sha256-aes-256-gcm"
AAD = b"stoma3d-portable-export-v1"
    ...
    *,
    ...
    with ZipFile(buffer, "w", compression=ZIP_DEFLATED, compresslevel=6) as archive:
        archive.writestr(
            ...
            (
                "Stoma3D portable data export\n\n"
                f"{DISCLAIMER}\n"
                "The decrypted file is a standard ZIP archive. JSON records use "
                "stoma3d.portable-export.v1. Measurements remain approximate unless "
