...
class Settings(BaseSettings):
    ...
    service_name: str = "stoma3d-platform-api"
    service_version: str = "0.1.0"
    environment: RuntimeEnvironment = RuntimeEnvironment.DEVELOPMENT
    database_url: str = Field(
        default="postgresql+asyncpg://stoma3d:stoma3d@127.0.0.1:5432/stoma3d",
        repr=False,
    )
    ...
    object_storage_bucket: str = "stoma3d-private"
    ...
    redis_stream_name: str = "stoma3d:jobs:v1"
    redis_cancel_prefix: str = "stoma3d:job-cancelled:v1:"
