...
JOB_SCHEMA_VERSION = "stoma3d.job.v1"
...
class CalibrationRequest(StrictModel):
    card_version: Literal["stoma3d-calibration-v1"] = "stoma3d-calibration-v1"
...
class DeleteAllPayload(StrictModel):
    ...
    scope: Literal["all_stoma3d_data"] = "all_stoma3d_data"
...
class JobEnvelope(StrictModel):
    schema_version: Literal["stoma3d.job.v1"] = JOB_SCHEMA_VERSION
    job_id: UUID
    request_id: UUID
    account_id: UUID
    trace_id: UUID
