...
RATE_LIMIT_PER_CLIENT_ENV = "ORALSIGHT_RATE_LIMIT_PER_CLIENT"
RATE_LIMIT_GLOBAL_ENV = "ORALSIGHT_RATE_LIMIT_GLOBAL"
RATE_LIMIT_WINDOW_ENV = "ORALSIGHT_RATE_LIMIT_WINDOW_SECONDS"
