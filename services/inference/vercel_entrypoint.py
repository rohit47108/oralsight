"""Vercel Services entry point for the Stoma3D FastAPI application.
...
from stoma3d_api.deployment import packaged_release_manifest  # noqa: E402


packaged_release = packaged_release_manifest(SERVICE_DIRECTORY)
if packaged_release is not None:
    os.environ.setdefault(
        "STOMA3D_RELEASE_MANIFEST_PATH",
        str(packaged_release),
    )

from stoma3d_api.main import app as inference_app  # noqa: E402
