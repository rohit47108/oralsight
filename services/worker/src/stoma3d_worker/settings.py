...
class Settings(BaseSettings):
    ...
    service_id: str = Field(default="stoma3d-worker", pattern=r"^[a-z0-9-]{3,64}$")
    ...
    stream_name: str = "stoma3d:jobs:v1"
    consumer_group: str = "stoma3d-workers-v1"
    retry_set: str = "stoma3d:jobs:retry:v1"
    dead_letter_stream: str = "stoma3d:jobs:dead:v1"
    retention_set: str = "stoma3d:jobs:retention:v1"
