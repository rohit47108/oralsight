...
def create_app(
    *,
    ...
    async def ready(request: Request):
        ...
        return {"status": "ready", "service": "stoma3d-worker"}
...
def cli() -> None:
    parser = argparse.ArgumentParser(description="Run or check the Stoma3D worker")
