...
- [ ] Eight-region mobile scan works from consent through report.
- [ ] Real capture, rejection, retry, interruption, and offline paths are verified.
- [ ] Observation map, history, comparison, PDF, sharing, and clinician paths work.
- [ ] Public website and signed-in shells have no dead navigation or fake records.
- [ ] Competition demonstration path is quick, clear, and reliable.
...
- [ ] Public GitHub `main` matches the verified local commit.
- [ ] GitHub Actions are green.
- [ ] Vercel project settings and environment values are correct.
