...
| -------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| Mobile               | Expo SDK 57 and Expo Router/Camera/Sensors/GL/SecureStore/SQLite/Print/Sharing modules; React 19.2.3; React Native 0.86; Reanimated 4.5; Skia 2.6.2; React Three Fiber 9.4; Three.js 0.181; Zustand 5; Noble crypto packages; base64-js | Preliminary dependency review only; regenerate and archive exact direct/transitive licenses and notices from `pnpm-lock.yaml` for the release |
| Inference            | FastAPI, Uvicorn, Pydantic, Cryptography, NumPy, OpenCV headless, Pillow, and python-multipart at the exact versions in `uv.lock`                                                                                                       | MIT/BSD/Apache/HPND-family terms apply by package; archive exact license texts and notices from the locked environment                        |
...
- [ ] A complete direct/transitive dependency and license notice matches both lockfiles.
- [ ] Required attribution/license texts ship with the release.
